...
extern void gr_pal_setblock(int start, int n, unsigned char* palette); //[ISB] these don't seem called ever?
...
//void gr_linear_line(int x0, int y0, int x1, int y1); [ISB] probably unused?
...
//void order(int* x1, int* x2); //[ISB] no references?