...
UI_GADGET_INPUTBOX* ui_add_gadget_inputbox(UI_WINDOW* wnd, short x, short y, short length, short slength, const char* text)
{
	int h, w, aw, f;
	...
	inputbox->text = (char*)mem_malloc(length + 1);
