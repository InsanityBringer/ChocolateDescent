...
unsigned char ui_converted_mouse_pointer[PTR_W * PTR_H]; //[ISB] why is char signedness not defined. Aaa
unsigned char ui_mouse_pointer[] = \
//"1111100000000000"\
//"1111111111000000"\
//"1144411111111111"\
//"1144444444111111"\
...
void ui_mouse_process()
{
	...
	if ((Mouse.b1_status & BUTTON_PRESSED) && (Mouse.b1_last_status & BUTTON_RELEASED))
	{
		...
		Mouse.moved = 0;
		Mouse.time_lastpressed = I_GetTicks();
...
void ui_mouse_init()
{
	...
	default_pointer = gr_create_bitmap_raw(PTR_W, PTR_H, (unsigned char*)ui_converted_mouse_pointer);
	Mouse.x = Mouse.y = 0;
	Mouse.backwards = 0;
	Mouse.hidden = 1;
...
grs_bitmap* ui_mouse_set_pointer(grs_bitmap* newbm)
{
