...
#define	NUM_LIGHTING_LEVELS 64
#define HALF_LIGHT 32
#define MAX_TMAP_VERTS 25
#define MAX_LIGHTING_VALUE	((NUM_LIGHTING_LEVELS-1)*F2_0/NUM_LIGHTING_LEVELS)
#define MIN_LIGHTING_VALUE	(F1_0/HALF_LIGHT)
