...
{
	Segment2s[Cursegp->segnum].special = SEGMENT_IS_FUELCEN;
...
{
	Segment2s[Cursegp->segnum].special = SEGMENT_IS_CONTROLCEN;
	fuelcen_activate( Cursegp, Segment2s[Cursegp->segnum].special);
	return 1;
}
...
{
	Segment2s[Cursegp->segnum].special = SEGMENT_IS_ROBOTMAKER;
	fuelcen_activate( Cursegp, Segment2s[Cursegp->segnum].special);
	return 1;
}
