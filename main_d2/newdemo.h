...
extern void newdemo_record_morph_frame(morph_data* md); //how did descent actually function
...
extern void newdemo_record_cloaking_wall(int front_wall_num, int back_wall_num, uint8_t type, uint8_t state, fix cloak_value, fix l0, fix l1, fix l2, fix l3);
