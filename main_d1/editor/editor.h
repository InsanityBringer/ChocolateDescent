...
extern void med_combine_duplicate_vertices(int8_t *vlp);
...
extern	int8_t	Been_visited[];					//	List of segments visited in a recursive search, if element n set, segment n done been visited
...
extern int med_point_2_vec(grs_canvas *canv,vms_vector *v,short sx,short sy);
